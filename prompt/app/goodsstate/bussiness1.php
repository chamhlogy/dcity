...
$Page_size=5; 
$a="select * from goods where username1='$username' and status=1";
...
$sql="select * from goods where username1='$username' and status=1 and state=1 limit $offset,$Page_size"; 
