...
$Page_size=5; 
$a="select * from goods where username2='$username' status=1 and state=0";
...
$sql="select * from goods where username2='$username' and status=1 and state=0 limit $offset,$Page_size"; 
...
$user->usernamea = $row['usernamea'];
$user->usernameb = $row['usernameb'];
$data[]=$user;
}
