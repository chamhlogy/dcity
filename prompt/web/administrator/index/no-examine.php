...
$sql="select * from bussiness where status=0 order by id asc"; 
$result=mysql_query($sql,$link);
?>	
    <meta name="description" content="待审核">
                ...
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display:block">
                            <li>
                                <!-- 打开状态 a 标签添加 active 即可   -->
                                <a href="no-examine.php" class="active">
                                    ...
                                    <tbody>
                                      <?php  while($row=mysql_fetch_array($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" data-am-modal="{target: '#<?php echo $row['username']?>3', closeViaDimmer: 0, width: 400, height: 275}">
                                                    营业执照
                                                </button>
                                            </td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary" onClick="pass(<?php echo $row['id'] ?>)"><span class="am-icon-pencil-square-o"></span> 通过</button>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onClick="notpass(<?php echo $row['id'] ?>)"><span class="am-icon-trash-o" id="notpass"></span> 不通过</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
